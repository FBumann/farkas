...
again here. Verbs that bind data belong in a caller's script: ``fk.solve``
...
from farkas.typeset import FORMATS, typeset
...
def main(argv: list[str] | None = None) -> int:
    ...
    for name in FORMATS:
        ...
        verb.add_argument('model', help='path to a farkas YAML model')
