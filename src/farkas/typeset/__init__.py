...
nothing about the syntax; a :class:`~farkas.typeset.format.Format` decides only
...
:class:`~farkas.typeset.symbols.SymbolTable` (a sidecar YAML, ``--symbols``)
...
or from a shell::
    ...
    python -m farkas typst model.yaml --standalone -o model.typ
"""
